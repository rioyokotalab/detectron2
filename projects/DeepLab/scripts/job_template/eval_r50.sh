...
# config_file="$config_root/deeplab_v3_R_50_torchvision_mg124_poly_40k_bs8.yaml"
config_file="$config_root/deeplab_v3_R_50_myencoder_mg124_poly_40k_bs8.yaml"

model_root=${MODEL_ROOT:-"$project_root/output/cityscapes/R50/byol/no_finetune/60k/my_pretrain_1000/20220426_223223"}
model_root=$(
    cd "$model_root" || exit
    pwd
)
model_filename="model_final"
# model_filename="model_0089999"
model_path="$model_root/$model_filename.pth"
# model_path=""

out_path="$model_root/eval/$model_filename/$date_str"
